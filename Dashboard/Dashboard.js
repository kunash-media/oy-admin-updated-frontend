...
function toggleLeftNav() {
    ...
    const mainContent = document.querySelector('.main-content'); // Updated to match HTML class
    
    if (leftNav && mainContent) {
        leftNav.classList.toggle('open');
        // mainContent.classList.toggle('shifted');
    } else {
        console.error('leftNavbar or main-content not found');
    }
}
...
function toggleDropdown() {
    ...
    if (dropdown) {
        ...
        console.error('profileDropdown not found');
    }
}
...
function toggleSubMenu(menuId) {
    ...
    if (menu && arrow) {
        ...
        console.error(`${menuId}Menu or ${menuId}Arrow not found`);
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dropdown = document.getElementById('profileDropdown');
    const profileIcon = document.querySelector('.profile-icon'); // Targets the div with class="profile-icon"
    ...
    if (dropdown && profileIcon) {
        ...
        console.error('profileDropdown or profile-icon not found');
    }
    ...
    if (leftNav && menuIcon && mainContent) {
        document.addEventListener('click', function(event) {
        ...
        console.error('leftNavbar, menu-icon, or main-content not found');
    }
    ...
    if (leftNav && mainContent) {
        ...
        console.error('leftNavbar or main-content not found for resize handler');
    }
});